...
override PKGDIR = xconfig_Projection_Clock
...
package/%.xdc.inc package/%_xconfig_Projection_Clock.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Projection_Clock" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Projection_Clock.pem4f

-include package/cfg/Projection_Clock_pem4f.mak
-include package/cfg/Projection_Clock_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Projection_Clock_pem4f.dep
endif
Projection_Clock.pem4f: package/cfg/Projection_Clock_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Projection_Clock.pem4f package/cfg/Projection_Clock_pem4f.c: .libraries,em4f
endif

package/cfg/Projection_Clock_pem4f.c package/cfg/Projection_Clock_pem4f.h package/cfg/Projection_Clock_pem4f.xdl: override _PROG_NAME := Projection_Clock.xem4f
package/cfg/Projection_Clock_pem4f.c: package/cfg/Projection_Clock_pem4f.cfg
package/cfg/Projection_Clock_pem4f.xdc.inc: package/cfg/Projection_Clock_pem4f.xdl
package/cfg/Projection_Clock_pem4f.xdl package/cfg/Projection_Clock_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Projection_Clock_pem4f.cfg
	-$(RM) package/cfg/Projection_Clock_pem4f.dep
	-$(RM) package/cfg/Projection_Clock_pem4f.c
	-$(RM) package/cfg/Projection_Clock_pem4f.xdc.inc

clean,em4f::
	-$(RM) Projection_Clock.pem4f
.executables,em4f .executables: Projection_Clock.xem4f

Projection_Clock.xem4f: |Projection_Clock.pem4f

-include package/cfg/Projection_Clock.xem4f.mak
Projection_Clock.xem4f: package/cfg/Projection_Clock_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/Projection_Clock_pem4f.oem4f   package/cfg/Projection_Clock_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Projection_Clock.xem4f: export C_DIR=
Projection_Clock.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Projection_Clock.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Projection_Clock.test test,em4f test: Projection_Clock.xem4f.test

Projection_Clock.xem4f.test:: Projection_Clock.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Projection_Clock.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Projection_Clock.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Projection_Clock.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) Projection_Clock.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Projection_Clock_pem4f.oem4f,copy : package/cfg/Projection_Clock_pem4f.oem4f
Projection_Clock_pem4f.sem4f,copy : package/cfg/Projection_Clock_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Projection_Clock
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Projection_Clock.tar.dep
endif
package/rel/xconfig_Projection_Clock/xconfig_Projection_Clock/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Projection_Clock/xconfig_Projection_Clock/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Projection_Clock/xconfig_Projection_Clock/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Projection_Clock/xconfig_Projection_Clock/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Projection_Clock.tar: package/rel/xconfig_Projection_Clock.xdc.inc package/rel/xconfig_Projection_Clock/xconfig_Projection_Clock/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Projection_Clock.xdc.inc,package/rel/xconfig_Projection_Clock.tar.dep)


release release,xconfig_Projection_Clock: all xconfig_Projection_Clock.tar
clean:: .clean
	-$(RM) xconfig_Projection_Clock.tar
	-$(RM) package/rel/xconfig_Projection_Clock.xdc.inc
	-$(RM) package/rel/xconfig_Projection_Clock.tar.dep
